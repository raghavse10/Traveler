...
class TestCaseForPassenger {
	...
	void setUp() throws Exception {
		...
		obj1 = new Passenger("", 201, new Category("STANDARD"), -2000, LS);			//No name, negative balance
		LS.clear();
	...
	@Test
	void testGetBalance() {
		assertEquals(0, obj3.getBalance());			//By default balance is 0 if negative balance is entered
	...
	void testGetName() {
		...
		assertEquals(null, obj2.getName());				//Name was not provided
		assertEquals("", obj1.getName());				//Name was empty string
	}
