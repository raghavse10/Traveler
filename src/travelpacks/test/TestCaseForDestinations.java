...
class TestCaseForDestinations {
	...
	void setUp() throws Exception {
		...
		LS1.add(new Activity("Skuba Diving", "Ahmedabad", "Fun activity", 300, 2));	//adding new activities at this destination
		d1 = new Destination("Ahmedabad", LS1);										//creating a destination
	...
	void testAddActivity() {
		...
		LS1.add(act1);																//adding an activity to check
		assertTrue(LS1.equals(d1.getActList()));
